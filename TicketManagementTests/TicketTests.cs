...
namespace TicketManagementTests {
	...
	public sealed class TicketTests : TestBase {
		...
		public void BasicGetEventTickets() {
			...
			var ticketType = _operations.GetEventTicketType(_testEvent.Id, _testEvent.TicketTypeIds.First());
			ticketType.Seats = ["A1"];
			var updatedTicketType = _operations.UpdateTicketType(_testEvent.Id, ticketType);
