...
namespace TicketManagementTests {
	...
	public sealed class TicketTests : TestBase {
		...
		public void BasicTicketTypeUpdateChangesTickets() {
			var tickets = _operations.GetEventTickets(_testEvent.Id, default, default);
			...
			var updatedTickets = _operations.GetEventTickets(_testEvent.Id, default, default);
		...
		public void BasicTicketReservation() {
			var ticket = _operations.GetEventTickets(_testEvent.Id, default, default).First();
